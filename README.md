...
```
sudo apt install -y git && ( [ -d hpc0-ubuntu-software/.git ] && cd hpc0-ubuntu-software && git pull || git clone https://github.com/michael-lehn/hpc0-ubuntu-software.git && cd hpc0-ubuntu-software ) && ./install
```
